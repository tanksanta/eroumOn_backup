...
<div class="modal modal-index fade " id="pop-welfare-1" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-2xl">
        ...
        <div class="modal-body space-no-x">
            <div class="flex flex-col gap-8 items-start">
                ...
                <div class="welfare-contact">
                    ...
                    <div>
                        <a href="#" class="btn btn-outline-primary2 btn-arrow btn-small mr-auto">문의처 바로가기</a>
        ...
        <div class="modal-footer flex-col md:flex-row gap-1 mt-6">
            <button type="button" class="btn btn-primary2 btn-arrow  large w-full md:w-2/5">내 인정등급 확인하기</button>
                <button type="button" class="btn btn-primary3 btn-arrow  large w-full md:w-2/5">요양정보 간편조회하기</button>
        </div>
        </div>
    </div>
</div>
