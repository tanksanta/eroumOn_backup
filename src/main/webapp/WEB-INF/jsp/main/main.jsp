        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide slide-item1" data-slide-number="1">
                <div class="content">
                    ...
                    <a href="/find/step2-1" target="_blank" class="btn btn-primary3 btn-arrow"><strong>내 인정등급 확인하기</strong></a>
                </div>
            </div>
            <div class="swiper-slide slide-item2" data-slide-number="2">
                <div class="content">
                    ...
                    <a href="/find/step2-1" target="_blank" class="btn btn-primary3 btn-arrow"><strong>지금 등급 확인하기</strong></a>
                </div>
            </div>
