...
<style>
    ...
    .object1,
    .object2 {max-width: 1800px; left:50% !important;--tw-translate-x:-50%; }
    ...
    .object1.hide,.object2.hide {opacity: 0; transition-delay: 0s; background-position: center 45% !important;}
    .object1,.object2  {z-index: 1;}
