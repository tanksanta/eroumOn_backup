...
<div id="visual" class="is-page1">
    <div class="image">
        <picture class="background">
            <source srcset="/html/page/index/assets/images/bg-page1-visual-m.jpg" media="(max-width: 768px)"> 
            <source srcset="/html/page/index/assets/images/bg-page1-visual.jpg"> 
            <img src="/html/page/index/assets/images/bg-page1-visual.jpg" alt="">
        </picture>
...
<div id="content">
    ...
    <div class="page1-content3">
        <h3 class="page1-title mb-5 md:mb-15 lg:mb-26">
