		...
		.done(function(data) {
			if(data.success) {
				...
				if (srvcInfo.refUrl) {
					...
					footerTemplate += `<a href="` + srvcInfo.refUrl + `" target="_blank" class="btn btn-primary2 btn-arrow btn-center large"><strong>자세한 신청방법 보기</strong></a>`;
				}
				// footerTemplate += `<a href="#" class="btn btn-share sm:hidden f_clip" data-bokji-id="` + srvcInfo.bokjiId + `">공유하기</a>`;
				footerTemplate += `<a href="#" class="btn btn-primary3 btn-arrow btn-center large sm:hidden f_clip" data-bokji-id="` + srvcInfo.bokjiId + `"><strong>공유하기</strong></a>`;
