...
<header id="header">
    ...
    <nav id="navigation">
        <ul class="nav-items">
            <li class="nav-item">
                <a href="${_mainPath}/cntnts/test">이로움 서비스</a>
	...
	<div id="utility">
		<ul>
			...
			<li>
				<a href="${_mainPath}/recipter/sub" class="cost">남은 혜택보기​</a>
			</li>
		</ul>
	</div>
...
<div id="allmenu" tabindex="-1" class="offcanvas offcanvas-end">
    ...
    <div class="offcanvas-body">
        ...
        <dl class="menu-item1">
            <dt><a href="${_mainPath}/cntnts/test"><img src="/html/page/index/assets/images/ico-allmenu1.png" alt=""> 이로움 서비스</a></dt>
            <dd>
                <ul>
