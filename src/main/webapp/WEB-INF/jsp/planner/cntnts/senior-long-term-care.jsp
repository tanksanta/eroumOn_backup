...
<%-- 장기요양보험 컨텐츠 --%>
		...
		<!-- 본문 영역 -->
        <div id="content">
            <div class="content-market-link is-insurance">
                <a href="${_marketPath}"><strong>이로움ON 마켓</strong> 복지용구부터 시니어 생활용품까지 한번에!</a>
            </div>
                    ...
                    <div class="card-item is-card2">
                        <div class="item-front">
                            <div class="front-content">
                                ...
                                <p class="desc">"월 최대 1,885,000원"</p>
                            </div>
                        </div>
                        <div class="item-rear">
                            <p>
            ...
            <div class="content-insurance5">
                <p class="cont1">
                    지금 <strong>이로움ON테스트</strong>를 통해<br>
                ...
                <div class="cont2">
                    ...
                    <script>
                        new QRCode(document.getElementById("qrcode"), "https://silver.bokji24.com/find/step2-1");
                    </script>
                </div>
            ...
            <div class="content-golink">
                ...
                <a href="#content" class="gotop"><span class="sr-only">위로 이동</span></a>
            </div>
