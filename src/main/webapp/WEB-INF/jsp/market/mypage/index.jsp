<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	<main id="container">
		<jsp:include page="../layout/page_header.jsp">
			<jsp:param value="MEMBERSHIP" name="pageTitle"/>
		</jsp:include>
        ...
        <div id="page-container">
            ...
            <div id="page-content">
            	<c:if test="${mbrVO.recipterYn eq 'N'}">
                <!-- 회원정보 -->
                <div class="mypage-myinfo ">
                    <div class="myinfo-photo">
                        <div class="thumb">
                        ...
                        <c:if test="${famMap.newCount > 0}"><p class="text-alert is-danger mt-2 text-sm font-medium">가족회원 승인 요청건이 있습니다</p></c:if>
                    </div>
                    <div class="myinfo-user">
                        <div class="grade">
                            ...
                            <div class="desc">
                            	<p class="text"><strong>${_mbrSession.mbrNm}</strong> 님은 <em>${recipterYnCode[_mbrSession.recipterYn]}</em>입니다.</p>
                            </div>
                        </div>
                        <ul class="service">
                            <li class="mileage">
                                <a href="${_marketPath}/mypage/mlg/list">
                                    <small>마일리지</small>
                                    <strong><fmt:formatNumber value="${mlgPointMap.mlg}" pattern="###,###" /></strong>
                                </a>
                            </li>
                            <li class="point">
                                <a href="${_marketPath}/mypage/point/list">
                                    <small>포인트</small>
                                    <strong><fmt:formatNumber value="${mlgPointMap.point}" pattern="###,###" /></strong>
                                </a>
                            </li>
                            <li class="coupon">
                                <a href="${_marketPath}/mypage/coupon/list">
                                    <small>쿠폰</small>
                                    <strong><fmt:formatNumber value="${ownCouponCnt}" pattern="###,###" /></strong> 장
                                </a>
                            </li>
                        </ul>
                        <ul class="notice">
                            <li class="interest">
                                <a href="${_marketPath}/mypage/wish/list">
                                    <small>관심상품</small>
                                    <strong>${mbrEtcInfoMap.totalWish}</strong>
                                </a>
                            </li>
                            <li class="cart">
                                <a href="${_marketPath}/mypage/cart/list">
                                    <small>장바구니</small>
                                    <strong>${mbrEtcInfoMap.totalCart}</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- 수급자 회원정보 -->
                <div class="mypage-myinfo is-recipient ">
                    <div class="myinfo-photo">
                        <div class="thumb">
                            <c:if test="${mbrVO.proflImg ne null && mbrVO.proflImg ne '' }"><img src="/comm/PROFL/getFile?fileName=${mbrVO.proflImg}" alt="" id="uploadFile" ></c:if>
                    ...
                    <div class="myinfo-user">
                        <div class="grade">
                            ...
                            <div class="desc">
                            	<p class="text">
		                            <strong>${_mbrSession.mbrNm}</strong> 님은 <em>${recipterYnCode[_mbrSession.recipterYn]}</em>입니다</p>
		                            <!-- <a href="#" class="link">일반회원으로 전환</a> -->
	                            </p>
                                <button type="button" class="btn btn-primary">나의 장기요양 정보</button>
                            </div>
                        </div>
                      ...
                      <div class="myinfo-recipient">
                      	<div class="left">
                            <div class="title">
                                나의
                                <strong>장기요양 정보</strong>
                            </div>
                            <div class="group1">
                                <dl class="number">
                                    <dt>장기요양인정번호</dt>
                                    <dd>L${mbrVO.recipterInfo.rcperRcognNo}</dd>
                                </dl>
                                <dl class="grades">
                                    <dt>등급</dt>
                                    <dd><img src="/html/page/market/assets/images/content2/num${mbrVO.recipterInfo.rcognGrad}.png" alt="3"></dd>
                                </dl>
                            </div>
                            <div class="group2">
                                <dl class="percent">
                                    <dt>본인부담율</dt>
                                    <dd><strong>${mbrVO.recipterInfo.selfBndRt}</strong> &nbsp; %</dd>
                                </dl>

                                <dl class="date">
                                    <dt>인정유효기간</dt>
                                    <dd>
                                        <p><fmt:formatDate value="${mbrVO.recipterInfo.vldBgngYmd}" pattern="yyyy-MM-dd" /></p>
                                        <p>~ <fmt:formatDate value="${mbrVO.recipterInfo.vldEndYmd}" pattern="yyyy-MM-dd" /></p>
                                    </dd>
                                </dl>
                                <dl class="date">
                                    <dt>적용기간</dt>
                                    <dd>
                                        <p><fmt:formatDate value="${mbrVO.recipterInfo.aplcnBgngYmd}" pattern="yyyy-MM-dd" /></p>
                                        <p>~ <fmt:formatDate value="${mbrVO.recipterInfo.aplcnEndYmd}" pattern="yyyy-MM-dd" /></p>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        <div class="right">
                            <div class="title">
                                <div class="update">
                                    <p>최근 업데이트 <strong><fmt:formatDate value="${mbrVO.recipterInfo.mdfcnDt}" pattern="yyyy-MM-dd" /></strong></p>
                                    <button type="button" class="btn btn-primary btn-large" id="updReBtn">요양정보 업데이트</button>
                                </div>
                            </div>
                            <dl class="price1">
                                <dt>급여잔액</dt>
                                <dd>
                                    <strong><fmt:formatNumber value="${mbrVO.recipterInfo.bnefBlce}" pattern="###,###" /></strong> &nbsp; 원
                                    <small id="viewFormat"></small>
                                </dd>
                            </dl>
                            <dl class="price2">
                                <dt>사용금액</dt>
                                <dd><strong><fmt:formatNumber value="${mbrVO.recipterInfo.sprtAmt - mbrVO.recipterInfo.bnefBlce}" pattern="###,###" /></strong> 원</dd>
                            </dl>
                        </div>
                        <button type="button" class="button f_display_recipter">닫기</button>
                    </div>
                </div>
                <!-- //수급자 회원정보 -->
                </c:if>
                ...
                <!-- 수급자 진행 주문 현황 -->
                <div class="mypage-myinfo-order is-recipient">
                    <div class="order-title">
                        <h2>진행중인 주문 현황</h2>
                        <ul>
                            <li>취소 <strong>${ordrSttsTyCntMap.ca01 + ordrSttsTyCntMap.ca02}</strong></li>
