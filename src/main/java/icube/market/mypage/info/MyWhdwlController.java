 ...
 */
@Controller
@RequestMapping(value="#{props['Globals.Market.path']}/mypage/whdwl")
public class MyWhdwlController extends CommonAbstractController{
	...
	public String list(
		...
		return "/market/mypage/whdwl/list";
	}
