...
public class FindInfoController extends CommonAbstractController {
	...
	public String srchId(
		...
		return "/market/mbr/info/srch_id";
	}
	...
	public View srchIdAction(
		...
		if(mbrVO != null) {
			...
			javaScript.setLocation("/"+marketPath + "/info/srchIdConfirm");
		}else {
	...
	public String srchIdConfirm(
		...
		if(mbrVO == null) { //임시세션 값이 없으면 아이디 찾기로
			return  "redirect:/" + marketPath + "/info/srchId";
		}

		model.addAttribute("mbrVO", mbrVO);

		return "/market/mbr/info/srch_id_confirm";
	}
	...
	public String srchPswd(
		...
		return "/market/mbr/info/srch_pswd";
	}
	...
	public View srchPswdAction(
		...
		if(receiptId != "") {
			...
			if(mbrVO != null) {
				...
				javaScript.setLocation("/"+marketPath+"/info/srchPswdConfirm");
			}else {
	...
	public String srchPswdConfirm(
		...
		// 로그인 체크
		if(mbrSession.isLoginCheck()){
			return  "redirect:/" + marketPath + "/index";
		}

		MbrVO mbrVO = (MbrVO) session.getAttribute(NONMEMBER_SESSION_KEY);
		if(EgovStringUtil.isEmpty(mbrVO.getMbrId())) { //임시세션 값이 없으면 아이디 찾기로
			return  "redirect:/" + marketPath + "/info/srchPswd";
		}

		return "/market/mbr/info/srch_pswd_confirm";
	}
	...
	public View srchPswdChg(
		...
		if(EgovStringUtil.isEmpty(mbrVO.getMbrId())) {
			javaScript.setLocation("redirect:/" + marketPath + "/info/srchPswd");
