package icube.common.util.egov;
...
public class EgovDoubleSubmitHelper {
	...
	public static boolean checkAndSaveToken(String tokenKey, HttpServletRequest request) {
		...
		System.out.println("EgovDoubleSubmitHelper.PARAMETER_NAME::::" + EgovDoubleSubmitHelper.PARAMETER_NAME);
		System.out.println("EgovDoubleSubmitHelper.PARAMETER_NAME.VAL::::" + parameter);
