...
//			}
	...
	public Map<String, Object> updateMbrRecipient(
		...
		MbrRecipientsVO updateRecipient = new MbrRecipientsVO();
		updateRecipient.setRecipientsNo(recipientsNo);
		...
		updateRecipient.setDong(dong);
		updateRecipient.setBrdt(brdt);
		updateRecipient.setGender(gender);
		
		return mbrRecipientsService.updateMbrRecipient(mbrSession.getUniqueId(), updateRecipient);
	}
